                      ...
                      <div className="widget-content">
                        <div className="text-widget ">
                          <div className="soc-icon text-center md:text-start">
                            <a className='mx-[3px] text-white inline-block w-[46px] h-[46px] rounded-[500px] border-[1px] border-solid border-yellow text-center transition-all ' href="http://instagram.com">  <FontAwesomeIcon className="fa-instagram text-md leading-[18px] text-yellow transition-all font-normal pt-[13px]"  icon={faInstagram} /> 
                            </a>
                            <a className='mx-[3px] text-white inline-block w-[46px] h-[46px] rounded-[500px] border-[1px] border-solid border-yellow text-center transition-all ' href="http://twitter.com">  <FontAwesomeIcon className="fa-twitter text-md leading-[18px] text-yellow transition-all font-normal pt-[13px]"  icon={faTwitter} /> 
                            </a>
                            <a className='mx-[3px] text-white inline-block w-[46px] h-[46px] rounded-[500px] border-[1px] border-solid border-yellow text-center transition-all ' href="http://instagram.com">  <FontAwesomeIcon className="fa-youtube text-md leading-[18px] text-yellow transition-all font-normal pt-[13px]"  icon={faYoutube} /> 
                            </a>
                          </div>	
                        </div>
                      </div>
                          ...
                          <ul className="footer-ul pl-0 leading-6 text-sm mt-0 mb-4">
                            ...
                            <li className="footer-ul1 mt-6 text-md font-semibold mb-1.5 leading-6 text-white">
                              <FontAwesomeIcon className='pr-[10px] font-black' icon={faEnvelope} />
                                 Contact</li>
                            <li className="footer-ul2 max-w-full  mb-6 md:max-w-[260px]"><a className='text-white transition-all' href="mailto:name@email.com">burgos@burgos.com</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>							
                    ...
                    <div className="widget widget_st_latest_posts_widget mb-12 text-center md:text-start">
                      <div className="widget-content">
                        ...
                        <div className="latest-posts inline-block mx-auto text-left ">
                          <div className="media overflow-hidden flex items-start">
                            <div className="pull-left pr-[10px] float-left">
                              <a href="/assets/images/latest-post1.webp">
                                <img width={64} height={64} src="/assets/images/latest-post1.webp" className="img-responsive text-white" sizes="(max-width: 64px) 100vw, 64px" />
                              </a>
                            </div>
                          <div className="media-body ml-[7px] table-cell align-top flex-1">
                            <h3 className="entry-title text-md font-semibold mb-1.5 leading-normal pt-0 m-0">
                              <a className='text-white' href="/">Alternative methods of food delivery logistic</a>
                            </h3>
                        ...
                        <div className="media mt-5 overflow-hidden flex items-start">
                          <div className="pull-left pr-[10px] float-left">
                            <a href="/">
                              <img width={64} height={64} src="/assets/images/latest-post2.webp" className="img-responsive text-white" alt=""   sizes="(max-width: 64px) 100vw, 64px" />
                            </a>
                          </div>
                          <div className="media-body ml-[7px] table-cell align-top flex-1">
                            <h3 className="entry-title text-md font-semibold mb-1.5 leading-normal pt-0 m-0">
                              <a className='text-white' href="/">Where and how do we keep the ingridients fresh?
                              </a>
                            </h3>
                            <div className="entry-meta text-[85%] text-[#888] font-normal">
                        ...
                        <div className="media mt-5 overflow-hidden flex items-start">
                          <div className="pull-left pr-[10px] float-left">
                            <a href="/">
                              <img width={64} height={64} src="/assets/images/latest-post3.webp" className="img-responsive text-white" alt=""  sizes="(max-width: 64px) 100vw, 64px" />
                            </a>
                        </div>
                          <div className="media-body ml-[7px] table-cell align-top flex-1">
                            <h3 className="entry-title text-md font-semibold mb-1.5 leading-normal pt-0 m-0">
                              <a className='text-white' href="">Not eating meat is decision, eating meat is an instict
                              </a>
                            </h3>
  ...
  <div className="section-inner flex flex-wrap mx-[-15px]">
    <div className="footer-credits basis-0 grow min-w-0 max-w-full relative w-full px-[15px]">
      <div className="copyright pt-12 border-t-2 border-t-border-footer text-gray text-center max-w-full border-solid relative w-full px-[15px]">
                2023				Design by 
        <a className='text-gray' href="/" target="_blank">Merkulove
        </a>. Development by 
        <a className='text-gray' href="/" target="_blank">RayoflightThemes
