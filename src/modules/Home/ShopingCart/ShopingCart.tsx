    ...
    <div className="shopping_cartwrapper">
      ...
      <div className="wcf-min-bottom-part w-full absolute mt-[10%] bottom-0 bg-[#ddd]">
        ...
        <p className="woo-commerce_mini_cart_button uppercase text-sm rounded font-normal inline-block min-w-[100px] min-h-[31px] mb-[22px] pt-1">
          <a className='text-white rounded inline-block min-w-[100px] min-h-[31px]  font-bold transition-all duration-[0.3s] ease-[ease] mx-2.5 my-0 p-2 bg-orange' href="/cart">Cart</a>
        </p>
        <p className="woo-commerce_mini_cart_button uppercase text-sm rounded font-normal inline-block min-w-[100px] min-h-[31px] mb-[22px] pt-1">
          <a href='/checkout'  className=' bg-orange inline-block min-w-[100px] min-h-[31px] text-white font-bold transition-all duration-[0.3s] ease-[ease] mx-2.5 my-0 p-2 uppercase'>Checkout</a>
        </p>
      </div>
