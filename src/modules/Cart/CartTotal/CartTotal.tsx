  ...
  return (
    <section className=' py-[24px]'>
      ...
      <div className="products xl:max-w-[50%] md:max-w-[70%] max-w-full w-full mr-3">
            ...
            <div className="w-full border-0 m-0 inline-flex relative min-w-0 flex-col align-top p-0 ">
              <div className='h-[36px] pl-[14px] relative rounded-[4px] w-full text-black cursor-text inline-flex  text-md  items-center font-normal leading-[1.1876em] border-[1px] border-solid border-dark-gray-color '>
                <div className="searchEl mr-2 h-[0.01em] flex max-h-[2em] items-center whitespace-nowrap">
                  <FontAwesomeIcon className='text-dark-gray-color' icon={faSearch} />
                </div>
        ...
        <p className='bg-gray-color leading-[20px] font-[500] text-md m-0 p-3'>All Products</p>
        <div className="product-list h-[500px] overflow-y-auto bg-white-color">
        ...
        <div className="xl:sticky top-0">
          <div className="bg-white-color text-black rounded-[3px]">
            ...
            <div className="px-4 py-3">
              ...
              <div className="px-4 py-3">
                <p onClick={deleteCart} className='leading-[20px] font-[500] text-xs text-black-navy-color underline cursor-pointer'>Delete Cart</p>
              </div>
            </div>
